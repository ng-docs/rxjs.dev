 ...
 *
 * **警告**：仅将其与你*知道*一定会完成的可观察者一起使用。如果源 observable 不会完成，你最终会得到一个挂起的 Promise，并且可能导致所有异步函数的状态都挂在内存中。为避免这种情况，请考虑添加 {@link timeout}、{@link take}、{@link takeWhile} 或 {@link takeUntil} 等操作符。
 *
 * ## Example
 *
 * ## 例子
